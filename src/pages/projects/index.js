  ...
  render() {
    return (
        <Container className="About-header" fluid={true}>
          <Helmet>
                <meta charSet="utf-8" />
                <title>Project | Samier Shovo</title>
                <link rel="canonical" href="http://shovo.tech/project"/>
                <meta name="description" content="Samier Shovo | About - Flutter Developer | Fullstack Web Developer | Software Engineer
