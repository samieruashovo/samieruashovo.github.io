...
class Contact extends React.Component {
  ...
  //   ReactGa.pageview('shovo.tech - Contact Screen');
  // }
  ...
  render() {
    return (
      <div>
        <Helmet>
                <meta charSet="utf-8" />
                <title>Contact | Samier Shovo</title>
                <link rel="canonical" href="http://shovo.tech/contact" />
                <meta name="description" content="Samier Shovo | Contact - Product Manager | Project Manager | Software Engineer" />
        </Helmet>
