          ...
          <Box>
            <Skeleton isLoaded={loadedimage1} color="white" fadeDuration={1}>
              <Image
                ...
                // style={{ width: "30%", height: "40%", objectFit: "fit" }}
              ></Image>
            </Skeleton>
          </Box>
          <Box>
            <Skeleton isLoaded={loadedimage2} color="white" fadeDuration={1}>
              <Image
                ...
                // style={{ width: "50%", height: "50%", objectFit: "fit" }}
              ></Image>
            </Skeleton>
          </Box>
        </Flex>
            ...
            <Box __css={styles}>
              <Box textAlign="center">
                <Link
                  to="#"
                  onClick={(e) => {
                    window.location.href = "mailto:samieruashovo@gmail.com";
                    e.preventDefault();
                  }}
                >
                  <Icon
